...
- If there is nothing to extract, return an empty tasks array. This includes recall/lookup questions ("what do I have for Chemistry", "what's due this week") — those aren't new tasks, so just return empty arrays and let the reply be generated from the current task list.
